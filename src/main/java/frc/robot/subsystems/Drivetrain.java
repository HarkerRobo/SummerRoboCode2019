...
public class Drivetrain extends HSDrivetrain {
    ...
    public static final double VELOCITY_RAMP_RATE = 0.5;
    ...
    private static final double MOTION_PROF_LEFT_kP = 2.4;//1.6; //2.7;//1;//1.6;//;1.3;
    private static final double MOTION_PROF_LEFT_kI = 0;
    private static final double MOTION_PROF_LEFT_kD = 10;//80;//50;//30;//20;
    private static final double MOTION_PROF_RIGHT_kF = rightkF;
    private static final double MOTION_PROF_RIGHT_kP = 1.7;//1;//1.4;
    private static final double MOTION_PROF_RIGHT_kI = 0;
    private static final double MOTION_PROF_RIGHT_kD = 6.6;//30;//20;//10;
